...
<#
.SYNOPSIS
    Supprime TOUTES les caméras de la base de données

.DESCRIPTION
    Ce script supprime toutes les caméras existantes pour permettre
    une reimportation propre depuis un fichier Excel.
    
    Les donnees de bandwidth associees seront mises a NULL automatiquement.
    Les autres equipements et la logique du Dashboard ne seront pas affectes.

.EXAMPLE
    .\DeleteAllCameras.ps1
#>
